	...
	, m_audio_track_canvas_item(AudioTrackCanvasItem::create(at))
{
	...
	m_audio_track_canvas_item->signal_height_changed ().connect
		(
		  sigc::mem_fun (this, &AudioTrackViewItem::on_track_canvas_item_height_changed)
		);
}
...
void
AudioTrackViewItem::on_track_canvas_item_height_changed ()
{
