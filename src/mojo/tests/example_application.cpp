...
ExampleApplication::ExampleApplication()
{
	...
	Application::connect_project_added(
	    boost::bind(&ExampleApplication::on_project_added, this, _1));
	Application::connect_project_removed(
	    boost::bind(&ExampleApplication::on_project_removed, this, _1));
}
