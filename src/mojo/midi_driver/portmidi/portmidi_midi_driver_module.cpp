...
std::string
PortmidiMIDIDriverModule::get_author()
{
	return "Tim Mayberry";
}

std::string
PortmidiMIDIDriverModule::get_description()
{
	return "Portmidi module";
}

std::string
PortmidiMIDIDriverModule::get_version()
{
	return "0.0.1";
}

MIDIDriverSP
PortmidiMIDIDriverModule::create_driver() const
{
