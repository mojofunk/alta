...
public:
	...
	*/
	...
	void set_property(const PropertyID& name, const ValueType& val)
	{
		m_properties.insert(Property(name, val));
	}

	template <class ValueType>
	void set_property(const std::string& name, const ValueType& val)
	{
		m_properties.insert(Property(name, val));
	}

	template <class ValueType>
	void get_property(const PropertyID& name, ValueType& val) const
	{
	...
	template <class ValueType>
	void get_property(const std::string& name, ValueType& val) const
	{
