...
/** @file ext/snd_filebuf.h
 *  This file is a GNU extension to the Standard C++ Library.
 */

#ifndef SND_FILEBUF_HPP
#define SND_FILEBUF_HPP 1
...
{
  /// @brief  class snd_filebuf.
  template<typename _CharT, typename _Traits = std::char_traits<_CharT> >
    class snd_filebuf : public std::basic_streambuf<_CharT, _Traits>
    {
    public:
      // Types:
  ...
  template<>
    inline snd_filebuf<char>::int_type
    snd_filebuf<char>::syncgetc()
    { return std::getc(_M_file); }

  template<>
    inline snd_filebuf<char>::int_type
    snd_filebuf<char>::syncungetc(int_type __c)
    { return std::ungetc(__c, _M_file); }

  template<>
    inline snd_filebuf<char>::int_type
    snd_filebuf<char>::syncputc(int_type __c)
    { return std::putc(__c, _M_file); }

  template<>
    inline std::streamsize
    snd_filebuf<char>::xsgetn(char* __s, std::streamsize __n)
    {
  ...
  template<>
    inline std::streamsize
    snd_filebuf<char>::xsputn(const char* __s, std::streamsize __n)
    { return std::fwrite(__s, 1, __n, _M_file); }

#ifdef _GLIBCXX_USE_WCHAR_T
  template<>
    inline snd_filebuf<wchar_t>::int_type
    snd_filebuf<wchar_t>::syncgetc()
    { return std::getwc(_M_file); }

  template<>
    inline snd_filebuf<wchar_t>::int_type
    snd_filebuf<wchar_t>::syncungetc(int_type __c)
    { return std::ungetwc(__c, _M_file); }

  template<>
    inline snd_filebuf<wchar_t>::int_type
    snd_filebuf<wchar_t>::syncputc(int_type __c)
    { return std::putwc(__c, _M_file); }

  template<>
    inline std::streamsize
    snd_filebuf<wchar_t>::xsgetn(wchar_t* __s, std::streamsize __n)
    {
  ...
  template<>
    inline std::streamsize
    snd_filebuf<wchar_t>::xsputn(const wchar_t* __s,
					std::streamsize __n)
    {
      std::streamsize __ret = 0;
      const int_type __eof = traits_type::eof();
  ...
  extern template class snd_filebuf<char>;
#ifdef _GLIBCXX_USE_WCHAR_T
  extern template class snd_filebuf<wchar_t>;
#endif
#endif
} // namespace __gnu_cxx
